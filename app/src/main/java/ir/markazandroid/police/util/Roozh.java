...
public class Roozh {
     ...
     *
     * @param unixTimeStamp <code>long</code>
     */
    public static String gregorianToPersian(long unixTimeStamp) {
    ...
    public static String getTime(long timestamp){
        ...
        return
                String.format("%02d:%02d:%2d",calendar.get(Calendar.HOUR_OF_DAY),
                        calendar.get(Calendar.MINUTE),calendar.get(Calendar.SECOND));
    }

    public static String getTimeNo(long timestamp){
        Calendar calendar = Calendar.getInstance();
        calendar.setTimeInMillis(timestamp);
        return
    ...
    public static String getCurrentTime(){
        return gregorianToPersian(System.currentTimeMillis())+" "+getTime(System.currentTimeMillis());
    }

    public static String getCurrentTimeNo(){
        return gregorianToPersian(System.currentTimeMillis());
    }
}