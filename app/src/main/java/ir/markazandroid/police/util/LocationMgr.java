...
public class LocationMgr {
    ...
    public void start(){
        ...
        refresherTimer.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                handler.post(() -> getLocation(context, new LocationResult() {
                    @Override
    ...
    {
        //I use LocationResult callback class to pass location value from LocationMgr to user code.
